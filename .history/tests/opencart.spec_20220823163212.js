...
const{demo_opencart_register} = require('./JS Files/demo_opencart_register.js');
...
test.describe('opencart test cases', async () =>{
    ...
    test(`@demo_opencart_register register the account`, async () =>{
        const login_2 = new demo_opencart_register(page);
        await page.pause();
        await login_2.initialize();
        await login_2.text_field();
    });
    test(`@demo_opencart_Login login the account`, async () =>{
        const login_3 = new demo_opencart_login(page);
        await page.pause();
        await login_3.initialize();
        await login_3.text_field();
